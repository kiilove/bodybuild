    ...
    <div className="flex min-w-full p-10 box-border flex-wrap ">
      <div className="flex flex-col flex-wrap w-full">
        <div className="flex w-full">
          <SpanTitle type="default" title="선수정보" />
        </div>
              ...
              {resData &&
                resData.map((item, idx) => (
                  <tr className="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                    <td className="p-4 w-4">{item.basicInfo.playerId}</td>
                    <td className="p-4 w-40">
                      <div className="flex gap-x-3 w-full justify-start items-center">
                        <img
                          src={item.basicInfo.playerProfile}
                          alt=""
                        ...
                        <div className="flex flex-col">
                          ...
                          <span>{item.basicInfo.playerEmail}</span>
                          <span>{item.basicInfo.playerTel}</span>
                        </div>
                      </div>
                    </td>
                    <td className="p-4 w-4">{item.basicInfo.playerLocation}</td>
                  </tr>
                ))}
            </tbody>
          </table>
